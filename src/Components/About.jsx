    ...
    <>
      <div className="AboutPage">
        <div className="AboutText">
          ...
          <p>
            Hi, my name is <b>Keyuri Gharat</b> and I am from Mumbai,
            India. I'm a <b>Frontend web developer</b> and a first year
            university student pursuing <b>BE in Computer Science ( AI ML )</b>. <br />
            <br />
            ...
            footer.
            <br />
            Apart from coding I love to Listen Podcast Make designs and do
            photography in my spare time.
          </p>
          <a href="keyuri.pdf" download className="resume-btn">
            <button>
